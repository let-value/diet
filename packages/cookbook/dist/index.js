...
var require_UnitMath = __commonJS((exports, module) => {
  (function(global, factory51) {
    typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory51() : typeof define === "function" && define.amd ? define(factory51) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.UnitMath = factory51());
  })(exports, function() {
    ...
    function createParser(options, findUnit) {
      ...
      function parseNumber() {
        ...
        if (c === "E" || c === "e") {
          ...
          number27 = number27 + tentativeNumber;
          while (isDigit(c)) {
            number27 += c;
            next();
          }
    ...
    function createUnitStore(options) {
      ...
      function findUnit(unitString) {
        ...
        for (const name48 of Object.keys(defs.units)) {
          if (unitString.substring(unitString.length - name48.length, unitString.length) === name48) {
            const unit = defs.units[name48];
            const prefixLen = unitString.length - name48.length;
...
var name44 = "createUnit";
var dependencies44 = ["typed", "Unit"];
var createCreateUnit = factory(name44, dependencies44, (_ref) => {
  var {
    typed,
    Unit
  } = _ref;
  return typed(name44, {
    ...
    "string, Unit | string | Object, Object": function stringUnitStringObjectObject(name45, def, options) {
      var obj = {};
      obj[name45] = def;
      return Unit.createUnit(obj, options);
    },
    "string, Unit | string | Object": function stringUnitStringObject(name45, def) {
      var obj = {};
      obj[name45] = def;
      return Unit.createUnit(obj, {});
    },
    string: function string(name45) {
      var obj = {};
      obj[name45] = {};
      return Unit.createUnit(obj, {});
    }
...
var name45 = "dot";
var dependencies45 = ["typed", "addScalar", "multiplyScalar", "conj", "size"];
var createDot = factory(name45, dependencies45, (_ref) => {
  var {
    typed,
    addScalar,
    multiplyScalar,
...
var name46 = "det";
var dependencies46 = ["typed", "matrix", "subtractScalar", "multiply", "divideScalar", "isZero", "unaryMinus"];
var createDet = factory(name46, dependencies46, (_ref) => {
  var {
    typed,
    matrix,
    subtractScalar,
...
var name47 = "inv";
var dependencies47 = ["typed", "matrix", "divideScalar", "addScalar", "multiply", "unaryMinus", "det", "identity", "abs"];
var createInv = factory(name47, dependencies47, (_ref) => {
  var {
    typed,
    matrix,
    divideScalar,
...
function mapRecipeContainer(container, map2) {
  let mapped = map2(container);
  if (!(mapped instanceof RecipeContainer)) {
    return mapped;
  }
  mapped = map2(Object.assign(Object.create(Object.getPrototypeOf(container)), container));
  mapped.children = container.children.map((child) => {
    if (child instanceof RecipeContainer) {
      return mapRecipeContainer(child, map2);
    }
    return map2(child);
  });
  return mapped;
...
function getIngredientKey({ key, name: name48 }) {
  const regex = /\(.*?\)/g;
  if (key) {
    return key;
  }
  const cleanName = name48?.replace(regex, "")?.trim();
  return cleanName ?? name48?.trim();
}
...
function gatherIngredients(recipe) {
  ...
  for (const [key, variants] of Object.entries(similar)) {
    ...
    const name48 = main?.name ?? variants.map(({ name: name49 }) => name49).find(Boolean);
    assertIngredientPart("name", name48);
...
var assertIngredientPart = function(part, name48) {
  if (!name48) {
